document.addEventListener('DOMContentLoaded', () => {
    ...
    const loadCourses = async () => {
        try {
            const response = await fetch('http://54.226.152.102:3000/api/courses');
    ...
    const loadStudents = async () => {
        try {
            const response = await fetch('http://54.226.152.102:3000/api/students');
    ...
    const loadEnrollments = async () => {
        try {
            const response = await fetch('http://54.226.152.102:3000/api/enrollments');
    ...
    document.getElementById('create-course-form').addEventListener('submit', async event => {
        ...
        try {
            const response = await fetch('http://54.226.152.102:3000/api/courses/create', {
                method: 'POST',
    ...
    document.getElementById('create-student-form').addEventListener('submit', async event => {
        ...
        try {
            const response = await fetch('http://54.226.152.102:3000/api/students/register', {
                method: 'POST',
                headers: {
    ...
    document.getElementById('enroll-student-form').addEventListener('submit', async event => {
        ...
        try {
            const response = await fetch('http://54.226.152.102:3000/api/enrollments/enroll', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const handleEdit = async (id, type) => {
        try {
            const response = await fetch(`http://54.226.152.102:3000/api/${type}s/${id}`);
            if (response.ok) {
